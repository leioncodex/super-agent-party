    ...
    for toolkit_file in toolkit_files:
        ...
        try:
            ...
            if hasattr(module, toolkit_name):
                ...
                if inspect.isclass(toolkit_class) and issubclass(
                    toolkit_class, BaseToolkit
                ):
...
def list_toolkit_functions(toolkit_name: str, include_methods: bool = True):
    ...
    for tool in tools:
        ...
        if isinstance(tool, FunctionTool):
            ...
            functions[name] = {"type": "tool", "description": "Tool function"}
    ...
    return {"status": "success", "toolkit": toolkit_name, "functions": functions}
    ...
    if not target_function:
        ...
        for name, member in inspect.getmembers(toolkit_instance):
            if (
                ...
                and name not in available_functions
            ):
